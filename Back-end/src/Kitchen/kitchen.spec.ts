import { addCategory, addMenu, createOrder, deleteMenu, deleteOrderItems, deleteOrderItemsPayAlready, deleteOrders, updateOrders } from "./resolve";
...
describe("deleteNullOrder", () => {
  test("deleteNull",async()=>{
    const result = await deleteOrderItemsPayAlready({});
    console.log("result",result);
  });
})